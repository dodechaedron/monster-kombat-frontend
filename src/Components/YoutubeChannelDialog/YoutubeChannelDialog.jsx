...
import { BACKEND_URL, TG_CHANNEL, YOUTUBE_CHANNEL } from '../../constants';
import axios from 'axios';
import { PointContext } from '../../state/PointContext';
import { openInNewTab } from '../XChannelDialog/XChannelDialog';

const YoutubeChannelDialog = ({ url, setDialogOpen }) => {

    const { setUser, setPoint } = useContext(PointContext);
    const [joined, setJoined] = useState(false);

    const handleJoin = () => {
        openInNewTab(url ? url : YOUTUBE_CHANNEL);
        setJoined(true);
    }
                    ...
                    <div className="earn-image is-coin-star">
                        <picture>
                            ...
                            <img
                                ...
                                src="/images/earn/hamster_youtube_channel.webp"
                                alt="subscribe_telegram_channel"
                            />
                        </picture>
                    </div>
