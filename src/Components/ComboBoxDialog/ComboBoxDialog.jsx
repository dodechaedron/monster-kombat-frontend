...
const ComboBoxDialog = ({ point, level, selectedCombo, setDialogOpen, setProfitPerHour, fetchDailyMatchs, setUser, fetchComboData }) => {
    ...
    const handleSubmitCombo = async () => {
        ...
        try {
            ...
            toast.success("Successfully Mined.")
            ...
            <div className="upgrade-buy">
                <div className="upgrade-buy-image ceo">
                    <div className="upgrade-image">
                        <picture className="is-rounded">
                            <source
                                srcSet={selectedCombo?.img ? selectedCombo?.img : '/images/skills/no-image.png'}
                                type="image/webp"
                                alt="ceo"
                            />
                            <img
                    ...
                    <li>
                        ...
                        <div className="upgrade-buy-stats-info">
                            <div className="price">
                                ...
                                <div className="price-value">+{toHumanString(selectedCombo.profitPerHour)}</div>
                            </div>
                        </div>
                    </li>
                </ul>
                <div className="upgrade-buy-info">
                    <div className="price">
                        ...
                        <div className="price-value">{toHumanString(selectedCombo.point)}</div>
                    </div>
                </div>
                <button
