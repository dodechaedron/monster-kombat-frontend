    ...
    return (
        <div className="bottom-sheet-scroll">
            <div className="bs-passive">
                <div className="text-center upgrade-buy-title ceo">Passive Income Earned</div>
                <div className="bs-passive-inner !py-6">
                    <div className='flex flex-row items-center justify-between gap-2'>
                        <img className='w-16 h-16' src="/images/coin64.png" />
                        <p className='pl-1 text-3xl text-white'>{new Intl.NumberFormat().format(bonus)}</p>
                    </div>
                </div>
                <p className="my-4 text-sm text-center">Congratulations</p>
