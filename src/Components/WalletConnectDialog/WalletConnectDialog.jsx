    ...
    return (
        <div className="bottom-sheet-scroll">
            <div className="bs-content">
                ...
                <div className="bs-content-title !text-4xl">Connect your Solana wallet</div>
                ...
                <div className="connect-ton-wallet">
                    <Link className="bg-[#fbd914] flex flex-row justify-center items-center font-bold gap-2 px-6 py-3 m-auto text-black !rounded-xl" to={`https://phantom.app/ul/browse/https%3A%2F%2F${FRONTEND_DOMAIN}%2Fwallet-connect%2F${user?.tg_id}?ref=https%3A%2F%2F${FRONTEND_DOMAIN}`} target='_blank'>
                        <div className="icon">
