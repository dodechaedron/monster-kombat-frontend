                ...
                <motion.div className="root" key="1" {...notCoinAppearence}>
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ transform: `scale(${buttonTransform.scale}) translateZ($buttonTransform.translateZ}px) rotateX(${buttonTransform.rotateX}deg) rotateY(${buttonTransform.rotateY}deg)` }}
                        >
                                ...
                                <div className="user-tap-button-inner">
                                    <div className="user-tap-button-circle">
                                        <picture className="is-hamster-image is-level-1" style={{ zIndex: 100 }}>
                                            <source srcSet={skin == SKINS[0] ? `/images/skins/skin${user.level}.png` : SKIN_DATA[skin].url} type="image/png" />
                                            <img className="img-responsive" src={skin == SKINS[0] ? `/images/skins/skin${user.level}.png` : SKIN_DATA[skin].url} alt="Monster Kombat" />
                                        </picture>
                                    </div>
                                </div>
                            </button>
