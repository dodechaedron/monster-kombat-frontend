            ...
            <div className="page">
                <main className="main">
                    <div className="inner settings">
                        ...
                        {/* <Link to="/settings/exchange" className="settings-item">
                            <div className="settings-item-content">
                                <p>Choose exchange</p><span>{exchange?.name}</span>
                            </div>
                            <div className="settings-item-action">
                                <div className="icon is-24"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" xmlSpace="preserve">
