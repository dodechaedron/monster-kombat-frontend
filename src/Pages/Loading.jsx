...
import { INSTAGRAM_CHANNEL_LINK, SITE_URL, TG_CHANNEL, X_CHANNEL_LINK } from '../constants';
            ...
            <div className="main">
                ...
                <div className="loading-launch">
                    <div className='z-50 flex flex-col items-center justify-center'>
                        ...
                        <p className='loading-subtitle'>From a Nobody to a Billionaire</p>
                    </div>
                    <div className="loading-launch-image">
                        <picture>
                            <source srcSet="/images/loading/bg_pupilz.png" type="image/png" />
                            <img src="/images/loading/bg_pupilz.png" alt="Loading screen" />
                        </picture>
                        {/* <div className='absolute bottom-0 right-0 w-[90%] max-h-[30vh]'>
                            <img src='/images/loading/car.png' />
                        </div>
                        <div className='absolute bottom-0 left-0 w-3/4 max-h-[55vh]'>
                            <img src='/images/loading/couple.png' />
                        </div> */}
                    </div>
                    ...
                    <div className="loading-launch-bottom">
                        ...
                        <div className="loading-launch-social">
                            ...
                            <ul>
                                <li>
                                    <a className="icon is-telegram" target='_blank' href={TG_CHANNEL}>
                                        <img src='/images/site-icon.svg' />
                                    </a>
                                </li>
                                <li>
                                    <a className="icon is-x" target='_blank' href={X_CHANNEL_LINK}>
                                        <svg
                                ...
                                <li>
                                    <a className="icon is-youtube" target='_blank' href={INSTAGRAM_CHANNEL_LINK}>
