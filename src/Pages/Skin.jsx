...
function Skin() {
    const { skin, setSkin, setUser, level, point, user, username } = useContext(PointContext);
                ...
                <main className="main">
                    ...
                    <div className="profile">
                        <div className="profile-header">
                            <div className="profile-header-user">
                                <div className="profile-header-user-avatar">
                                    <picture>
                                        <source
                                            src={`/images/skins/skin${user.level}.png`}
                                            type="image/png"
                                        />
                                        <img src={`/images/skins/skin${user.level}.png`} />
                                    </picture>
                                </div>
                        ...
                        <div className="profile-skins">
                            ...
                            <div className="profile-skins-inner">
                                <div className="profile-skin">
                                    ...
                                    <div className="profile-skin-info">
                                        ...
                                        <div className="profile-skin-button">
                                            <button
                                                className={`button button-default button-primary ${currentSkin == skin ||
                                                    point < SKIN_DATA[currentSkin].points ||
                                                    level < SKIN_DATA[currentSkin].level ? 'is-disabled-blue' : ''}`}
                                                onClick={() => {
